...
import 'package:myteam/model/event.dart';
import 'package:myteam/model/match.dart';
import 'package:myteam/model/statistic.dart';
import 'package:myteam/model/table.dart' as table;
import 'package:myteam/provider/ads_provider.dart';
import 'package:myteam/screens/home/live_widget.dart';
...
class MatchDetail extends StatefulWidget {
  ...
  MatchDetail({required this.match, required this.tag,this.back = true});
...
class _MatchDetailState extends State<MatchDetail> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        (widget.back) ? Navigator.of(context).pop() : Navigator.pushReplacementNamed(context, "/home");
        return false;
      },
      child: Container(
