...
class CompetitionsWidget extends StatefulWidget {
  ...
  CompetitionsWidget({required this.competitions, required this.action});
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: (widget.competitions[index].selected == true)? Theme.of(context).colorScheme.secondary :Theme.of(context).cardColor,
            borderRadius: BorderRadius.circular(10),
          ),
          child: Padding(
