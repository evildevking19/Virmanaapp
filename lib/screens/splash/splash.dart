...
class Splash extends StatefulWidget {
  ...
  Splash({required this.post, required this.status,required this.appname,required this.appsubname, required this.type,required this.data,required this.applogo,required this.appsponsors,required this.info});
...
class _SplashState extends State<Splash> {
  ...
  Future<Match?>  _getMatch() async{
    ...
    if (statusCode == 200) {
      ...
      Route route = MaterialPageRoute(builder: (context) => MatchDetail(match:_match,back : false, tag: 0,));
  ...
  Future<Post?>  _getPost() async{
    ...
    if (statusCode == 200) {
      ...
      switch(_post.type){
        case "youtube":
          Route route = MaterialPageRoute(builder: (context) => YoutubeDetail(post:_post,back : false, postFavorite: Null as Function));
          Navigator.pushReplacement(context, route);
          break;
        case "video":
          Route route = MaterialPageRoute(builder: (context) => VideoDetail(post:_post,back : false, postFavorite: Null as Function,));
          Navigator.pushReplacement(context, route);
          break;
        default:
          Route route = MaterialPageRoute(builder: (context) => PostDetail(post:_post,back : false, postFavorite: Null as Function,));
          Navigator.pushReplacement(context, route);
          break;
      }
    } else {
  ...
  Future<Status?>  _getStatus() async{
    ...
    Status _status =  Status.fromJson(jsonData);
      ...
      switch(_status.kind){
        case "image":
          Route route = MaterialPageRoute(builder: (context) => ImageDetail(status: _status ,back : false, liked: Null as Function, shared: Null as Function, viewed: Null as Function, downloaded: Null as Function,));
          Navigator.pushReplacement(context, route);
          break;
        case "quote":
          Route route = MaterialPageRoute(builder: (context) => QuoteDetail(status: _status ,back : false, liked: Null as Function, viewed: Null as Function, shared: Null as Function));
          Navigator.pushReplacement(context, route);
          break;
        default:
          Route route = MaterialPageRoute(builder: (context) => StatusDetail(status: _status,back : false, liked: Null as Function, shared: Null as Function, viewed: Null as Function, downloaded: Null as Function,));
          Navigator.pushReplacement(context, route);
          break;
      }
    } else {
