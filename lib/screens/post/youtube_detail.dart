...
class YoutubeDetail extends StatefulWidget {
  ...
  YoutubeDetail({required this.post,required this.postFavorite, this.back = true});
                      ...
                      floatingActionButton: FloatingActionButton(
                        ...
                        onPressed: (){
                         // Route route = MaterialPageRoute(builder: (context) => CommentsList(post:widget.post));
                          Route route = MaterialPageRoute(builder: (context) => CommentsList(post: widget.post, status: Null as Status,));
                          push(context, route);
                        },
                      ),
