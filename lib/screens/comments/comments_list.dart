...
import 'package:myteam/screens/comments/comment_widget.dart';
...
class CommentsList extends StatefulWidget {
  ...
  CommentsList({required this.post,required this.status});
     ...
     String? username = await prefs.getString("NAME_USER");
      ...
      if(statusCode == 200 ){
        if(jsonData["code"] == 200){
          ...
          Comment new_comment =  new Comment(content:comment_base_64,created: "Now",clear: comment,userid: id_user!,userimage: userimage!, username:username!, enabled: true, id: 0);
          setState(() {
