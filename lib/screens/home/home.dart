...
class _HomeState extends ResumableState<Home> {
                        ...
                        child: Padding(
                          ...
                          child: SafeArea(
                            child: GNav(
                                ...
                                tabBackgroundColor: Theme.of(context).textTheme.bodyText2!.color!.withOpacity(0.1),
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Icon(LineIcons.angleUp,color: Theme.of(context).colorScheme.secondary,size: 18),
                                    ],
                                  ),
                                ),
                              ),
  ...
  Future onSelectNotification(String payload) async {
      ...
      if(parsed["type"] == "link"){
        ...
        Route route = MaterialPageRoute(builder: (context) => Splash(post:parsed["data"], status: '', appname: '', appsubname: '', type: '', data: '', applogo: '', appsponsors: '', info: ''));
        Navigator.pushReplacement(context, route);
      }else if (parsed["type"] == "status"){
        Route route = MaterialPageRoute(builder: (context) => Splash(status:parsed["data"], post: '', appname: '', appsubname: '', type: '', data: '', applogo: '', appsponsors: '', info: '',));
        Navigator.pushReplacement(context, route);
      }
  }
