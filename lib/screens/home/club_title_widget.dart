...
class ClubItemWidget extends StatelessWidget {
  ...
  ClubItemWidget({this.team,required this.navigate});
            ...
            children: <Widget>[
              ...
              Positioned(
                child: Container(
                  decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(10),
                      color:(team.position % 2 == 0)? Colors.black.withOpacity(0.45):Theme.of(context).colorScheme.secondary.withOpacity(0.45),
                      boxShadow: [BoxShadow(
              ...
              Positioned(
                ...
                left: 15,
                child: Container(
                  color:(team.position % 2 == 0)? Theme.of(context).colorScheme.secondary.withOpacity(0.9):Colors.black.withOpacity(0.45).withOpacity(0.9),
                  child: Padding(
