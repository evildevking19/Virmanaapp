  ...
  void insertAds(){
    if(native_ads_position  ==  native_ads_item){
      ...
      if(native_ads_type == "ADMOB"){
        statusList.add(Status(id:-5, kind: '', description: '', review: false, comment: false, comments: 0, downloads: 0, views: 0, username: '', userid: -1, userimage: '', trusted: false, type: '', extension: '', thumbnail: '', original: '', image: '', color: '', created: '', likes: 0, shares: 0, quote: ''));
      }else if(native_ads_type =="FACEBOOK"){
        statusList.add(Status(id:-6, kind: '', description: '', review: false, comment: false, comments: 0, downloads: 0, views: 0, username: '', userid: -1, userimage: '', trusted: false, type: '', extension: '', thumbnail: '', original: '', image: '', color: '', created: '', likes: 0, shares: 0, quote: ''));
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              if(statusList[index] == null){
                ...
                return CreateWidget(post: Null as Post,);
  ...
  Future<List<Status>?>  _getList() async{
    ...
    if (statusCode == 200) {
      if (response.statusCode == 200) {
        ...
        statusList.add(Null as Status);
        statusList.add(Status(id: -1, kind: '', description: '', review: false, comment: false, comments: 0, downloads: 0, views: 0, username: '', userid: -1, userimage: '', trusted: false, type: '', extension: '', thumbnail: '', original: '', image: '', color: '', created: '', likes: 0, shares: 0, quote: ''));
