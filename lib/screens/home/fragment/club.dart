...
import 'package:myteam/model/social.dart';
...
import 'package:myteam/screens/home/club_title_widget.dart';
import 'package:myteam/screens/home/social_widget.dart';
...
class _ClubState extends State<Club> {
  ...
  Future<List<Team>?>  _getList() async{
    ...
    if (response.statusCode == 200) {
      ...
      for(Map<String, dynamic> i in socialsjsonData){
        Social social = Social.fromJson(i);
        socialList.add(social);
      }
      teamList.add(Team(id: 0, title: '', subtitle: '', image: '', icon: '', position: 0, type: ''));

      if(socialList.length>0){
        teamList.add(Team(id: -1, title: '', subtitle: '', image: '', icon: '', position: 0, type: ''));
      }
      for(Map<String, dynamic> i in itemsjsonData){
