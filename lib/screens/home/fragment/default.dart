...
class _DefaultState extends State<Default> {
  ...
  late int ads_interstitial_click;
  late String ads_interstitial_type;

  bool _isInterstitialAdLoaded = false;
  bool _interstitialReady = false;

  late String interstitial_facebook_id;
  late String interstitial_admob_id;
    ...
    InterstitialAd.load(
        ...
        adLoadCallback: InterstitialAdLoadCallback(
          ...
          onAdFailedToLoad: (LoadAdError error) {
            ...
            _admobInterstitialAd = Null as InterstitialAd;
  ...
  Future<List<Post>?>  _getList() async{
    ...
    if (response.statusCode == 200) {
      ...
      for(Map<String, dynamic> i in playersjsonData){
        Player player = Player.fromJson(i);
        playersList.add(player);
      }

      for(Map<String, dynamic> i in matchesjsonData){
      ...
      for(Map<String, dynamic> i in questionsjsonData){
      ...
      postsList.add(Post(id: -1, title: '', image: '', created: '', views: 0, shares: 0, comments: 0, comment: false, content: '', type: '', date: '', video: ''));
      if(matchesList.length>0){
        postsList.add(Post(id: -2, title: '', image: '', created: '', views: 0, shares: 0, comments: 0, comment: false, content: '', type: '', date: '', video: ''));
      }
      if(playersList.length>0){
        postsList.add(Post(id: -3, title: '', image: '', created: '', views: 0, shares: 0, comments: 0, comment: false, content: '', type: '', date: '', video: ''));
      }

      if(questionsList.length>0){
        postsList.add(Post(id: -4, title: '', image: '', created: '', views: 0, shares: 0, comments: 0, comment: false, content: '', type: '', date: '', video: ''));
      }



      for(Map<String, dynamic> p in postsjsonData){
  ...
  void insertAds(){
    if(native_ads_position  ==  native_ads_item){
      ...
      if(native_ads_type == "ADMOB"){
        postsList.add(Post(id:-5, title: '', image: '', created: '', views: 0, shares: 0, comments: 0, comment: false, content: '', type: '', date: '', video: ''));
      }else if(native_ads_type =="FACEBOOK"){
        postsList.add(Post(id:-6, title: '', image: '', created: '', views: 0, shares: 0, comments: 0, comment: false, content: '', type: '', date: '', video: ''));
