...
class _MatchesState extends State<Matches> {
  ...
  late Competition selected_competition;
  ...
  void insertAds(){
    if(native_ads_position  ==  native_ads_item){
      ...
      if(native_ads_type == "ADMOB"){
        matchesList.add(Match(id:-5, title: '', homeresult: '', awayresult: '', homesubresult: '', awaysubresult: '', date: '', time: '', stadium: '', highlights: '', state: '', competition: Null as Competition, awayclub: Null as Club, homeclub: Null as Club));
      }else if(native_ads_type =="FACEBOOK"){
        matchesList.add(Match(id:-6, title: '', homeresult: '', awayresult: '', homesubresult: '', awaysubresult: '', date: '', time: '', stadium: '', highlights: '', state: '', competition: Null as Competition, awayclub: Null as Club, homeclub: Null as Club));
  ...
  Future<List<CompetitionsWidget>?> _getList() async{
    ...
    if (statusCode == 200) {
      if (response.statusCode == 200) {
        ...
        Competition all_competition = Competition(id: 0,selected: true, name: '', image: '', tables: [], season: '');
