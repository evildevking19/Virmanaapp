...
import 'package:myteam/screens/players/player_detail.dart' as PlayerScreen;

class PlayerWidget extends StatelessWidget {
  Player player;
  String bgimage;

  PlayerWidget({required this.player,required this.bgimage});
              ...
              child: Container(
                  ...
                  decoration: BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [Theme.of(context).colorScheme.secondary, Theme.of(context).colorScheme.secondary.withOpacity(0.3),Colors.transparent],
                      )
                  )
              ),
            ),
