...
import 'package:myteam/model/position.dart';
import 'package:http/http.dart' as http;
import 'package:myteam/model/team.dart';
import 'package:myteam/screens/loading.dart';
import 'dart:convert' as convert;

import 'package:myteam/screens/players/player_widget.dart';
...
class PlayersList extends StatefulWidget {
  ...
  Team team;
  PlayersList({required this.team});
  ...
  Widget? buildHome() {
    switch(state){
      ...
      case "progress":
        ...
        break;
      case "error":
        return TryAgainButton(action: Null as Function);
        break;
    }
  }
