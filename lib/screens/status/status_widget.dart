...
import 'package:myteam/screens/other/report.dart';
...
class StatusWidget extends StatefulWidget {
  ...
  StatusWidget({required this.status,required this.liked, required this.shared, required this.viewed,required this.downloaded,required this.navigate});
...
class _StatusWidgetState extends State<StatusWidget> {
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: Material(
                      ...
                      child: InkWell(
                        onTap: (){
                          Route route = MaterialPageRoute(builder: (context) => CommentsList(status:widget.status, post: Null as Post,));
  ...
  Future<void> _capturePng() async {
    try {
      ...
      String bs64 = base64Encode(pngBytes as List<int>);
      print(pngBytes);
      print(bs64);
