...
class StatusDetail extends StatefulWidget {
  ...
  StatusDetail({required this.status,required this.liked, required this.shared, required this.viewed,required this.downloaded,this.back = true});
