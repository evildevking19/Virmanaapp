...
import 'package:myteam/screens/status/create_image.dart';
import 'package:myteam/screens/status/create_quote.dart';
import 'package:myteam/screens/status/create_video.dart';
...
class CreateWidget extends StatefulWidget {
  Post post ;
  CreateWidget({required this.post});
              ...
              children: <Widget>[
                Expanded(
                  ...
                  child:  ButtonTheme(
                    ...
                    child: ElevatedButton.icon(
                      onPressed: (){
                        Route route = MaterialPageRoute(builder: (context) => CreateImage(staff: Null as Staff,));
                        push(context, route);
                      },
                      icon: Icon(
                        LineIcons.image,
                ...
                Expanded(
                  ...
                  child:  Container(
                    ...
                    child: ButtonTheme(
                      ...
                      child: ElevatedButton.icon(
                        onPressed: (){
                          Route route = MaterialPageRoute(builder: (context) => CreateVideo(staff: Null as Staff,));
                          push(context, route);
                        },
                        icon: Icon(
                          LineIcons.video,
                ...
                Expanded(
                  ...
                  child: ButtonTheme(
                    ...
                    child: ElevatedButton.icon(
                      onPressed: (){
                        Route route = MaterialPageRoute(builder: (context) => CreateQuote(staff: Null as Staff,));
                        push(context, route);
                      },
                      icon: Icon(
                          LineIcons.quoteLeft,
