...
class ArticleWidget extends StatelessWidget {
  ...
  ArticleWidget({required this.article,required this.index,required this.navigate});
            ...
            children: <Widget>[
              ...
              Positioned(
                child: Container(
                  decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(10),
                      color:(index % 2 == 0)? Colors.black.withOpacity(0.45):Theme.of(context).colorScheme.secondary.withOpacity(0.45),
                      boxShadow: [BoxShadow(
