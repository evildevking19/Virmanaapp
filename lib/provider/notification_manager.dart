...
class NotificationManager{
  ...
  InitializationSettings initSetting = new InitializationSettings();
        ...
        onDidReceiveNotificationResponse: (NotificationResponse notificationResponse) {
          switch (notificationResponse.notificationResponseType) {
            case NotificationResponseType.selectedNotification:
              onNotificationClicked(notificationResponse.payload);
              break;
  ...
  showNotificationWithAttachment(String _id,String title,String message,String image,String icon,String payload) async {
    ...
    if(image != null && image != "null"){
      ...
      iOSPlatformSpecifics = DarwinNotificationDetails(
